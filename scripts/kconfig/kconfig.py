...
def main():
    ...
    if args.kconfig_base:
        os.environ['KCONFIG_BASE'] = args.kconfig_base
    ...
    if (('WARN_DEPRECATED' in kconf.syms) and
            (kconf.syms['WARN_DEPRECATED'].tri_value == 2)):
        check_deprecated(kconf)

    if (('WARN_EXPERIMENTAL' in kconf.syms) and
            (kconf.syms['WARN_EXPERIMENTAL'].tri_value == 2)):
...
def parse_args():
    ...
    parser.add_argument("--forced-input-configs",
                        ...
                        help="Indicate the input configuration files are "
                             ...
                             " adjustments.")
    parser.add_argument("--kconfig-base",
                        help="Path to project base dir")
